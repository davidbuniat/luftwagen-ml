...
thetaMatrix = np.matrix([ [random.uniform(0.0, 1000.0)], [random.uniform(0.0, 1000.0)], [random.uniform(0.0, 1000.0)], [random.uniform(0.0, 1000.0)], [random.uniform(0.0, 1000.0)], [random.uniform(0.0, 1000.0)] ])
def costFunction(x):
	totalErr = 0
